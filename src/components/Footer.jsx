...
export const Footer = () => {
  ...
  return (
    ...
    <div class="start-logo" style={{textAlign:'center',marginLeft:"2vh" }}>
      { darkMode?
                <img src={logoDark} style={{height:'30px',marginTop:'10px',align:'center',width:'200px',marginLeft:'auto',marginRight:'auto'}} alt="logo"/>
                :
                <img src={logo} style={{height:'30px',marginTop:'10px',align:'center',width:'200px',marginLeft:'auto',marginRight:'auto'}} alt="logo"/>
                }
      </div>
      <div class="community">
