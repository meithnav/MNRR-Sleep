...
export const FooterMobile = () => {
  const {darkMode} = useContext(ThemeContext) ;
    ...
    <AppBar position="relative" sx={{ top: "auto", bottom: 20 }} className={darkMode ? classes.darkroots : classes.roots}>
      ...
      { darkMode?
                <img src={logoDark} style={{height:'40px',marginTop:'10px',align:'center',width:'250px',marginLeft:'auto',marginRight:'auto'}} alt="logo"/>
                :
                <img src={logo} style={{height:'40px',marginTop:'10px',align:'center',width:'250px',marginLeft:'auto',marginRight:'auto'}} alt="logo"/>
                }
      </div>
